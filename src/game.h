...
extern UInt16  GameInitialize(PreferencesType *)                      __GAME__;
extern void    GameReset()                                            __GAME__;
extern void    GameSave(PreferencesType *)                            __GAME__;
extern void    GameRestore(PreferencesType *)                         __GAME__;
